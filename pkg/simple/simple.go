// Package simple is a very simplified parser based on byte matching that
// extracts only the identification numbers and driver names from a
// tachograph (VU) or driver card file. It does not require the ERCA
// certificates and does not perform any signature verification.
package simple
